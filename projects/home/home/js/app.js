...
function sliders_bild_callback() {
	let slider_about = new Swiper('.block-page__slider_1', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
	...
	let slider_about2 = new Swiper('.block-page__slider_2', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
	...
	slider_about.controller.control = slider_about2;
	slider_about2.controller.control = slider_about;
}
